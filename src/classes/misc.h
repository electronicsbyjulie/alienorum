...
extern bool show_grid, show_consln, show_xonsm, show_labels, show_orbits, lbl_localsys, is_mouse_over_window, dragging, dragged, viewchanged,
    objinfwnd, statuswnd, objedtwnd, satwnd, addcelwnd, hide_mouse, searched, draw_actual_conslines, explorer, show_taucalc, randomize_txgen;
...
extern float has_water, ice_amount, veg_height, mtn_height, snow_height;
