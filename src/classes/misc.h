...
extern bool show_grid, show_consln, show_xonsm, show_labels, show_orbits, lbl_localsys, show_sats, satview_upsidedown,
    is_mouse_over_window, dragging, dragged, viewchanged,
